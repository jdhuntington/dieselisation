Feature: Manage private auctions
  ...
  Scenario: Everyone buys the cheapest
    ...
    When I choose to buy the "Lexington Terminal RR" for 20
    ...
    When I choose to buy the "Midland Railroad Co." for 40
    And I confirm my action
    ...
    When I choose to buy the "Waycross & Southern RR" for 70
    And I confirm my action
    ...
    When I choose to buy the "Ocilla Southern RR" for 100
    And I confirm my action
    ...
    When I choose to buy the "Macon & Birmingham RR" for 150
    And I confirm my action
    Then I should see that it is Bob's turn